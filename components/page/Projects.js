    ...
    <div className="h-full"> 
      <div className="pt-20 text-white pb-10 text-center">
        ...
        <BlurText
                  ...
                  animateBy="chars"
                  direction="top"
                  className="cursor-pointer text-4xl md:text-5xl lg:text-6xl font-bold  mb-4 flex justify-center text-blue-100"
                />
        <BlurText
                  ...
                  animateBy="chars"
                  direction="top"
                  className="text-lg max-w-2xl mx-auto text-gray-400 font-light"
                />
      </div>
